...
#%%
#function for selection of points for multiple families
...
# ax2.yaxis.set_ticks([])
fig2.show()
fig2.savefig('kernel2d.png', bbox_inches='tight',dpi=600)
...
#==============================================================================
if input('Do you have multiple families (yes or no)') == 'yes':
    ############################################################
    #Family1
